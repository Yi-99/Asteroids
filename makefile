...
#     Yirang Lim
# Summary:
#     Moves across the screen and implements screen wrapping
# Above and Beyond
...
# Build the main game
###############################################################
a.out: driver.o game.o uiInteract.o uiDraw.o point.o velocity.o ship.o bullet.o rocks.o
	g++ driver.o game.o uiInteract.o uiDraw.o point.o velocity.o ship.o bullet.o rocks.o $(LFLAGS)
